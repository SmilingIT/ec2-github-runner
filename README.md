...
| `github-token`                                                                                                                                                               | Required if `github-registration-token` is not provided.                           | GitHub Personal Access Token with the `repo` scope assigned.                                                                                                                                                                                                                                                                          |
| `github-registration-token`                                                                                                                                                               | Required if `github-token` is not provided.                           | GitHub registration token for runner registration.                                                                                                                                                                                                                                                                          |
    ...
    steps:
      ...
      - name: Start EC2 runner
        ...
        with:
          ...
          # OR: github-registration-token: 123456789abcdefg
